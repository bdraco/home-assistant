...
class BalboaSpaClimate(BalboaEntity, ClimateEntity):
    ...
    def __init__(self, hass, entry, client, devtype, num=None):
        ...
        self._ha_to_balboa_blower_map = {
            v: k for k, v in self._balboa_to_ha_blower_map.items()
        }
        ...
        self._ha_heatmode_to_balboa_map = {
            v: k for k, v in self._balboa_to_ha_heatmode_map.items()
        }
        ...
        self._attr_min_temp = self._client.tmin[trange][scale]
        self._attr_max_temp = self._client.tmax[trange][scale]
    ...
    async def async_set_temperature(self, **kwargs):
        ...
        await self._client.send_temp_change(kwargs[ATTR_TEMPERATURE])
