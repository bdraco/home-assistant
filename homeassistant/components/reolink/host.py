...
class ReolinkHost:
    ...
    async def update_states(self) -> None:
        ...
        # It would be nice if cmd_list was typed to Collection to avoid copying
        # to a list, since that is what it really wants anyways, and using a list
        # has to do linear search for each command
        await self._api.get_states(cmd_list=list(self._update_cmd))
